...
public class BookApp {
	...
	public static void main(String[] args) {
		...
		// 책 등록(insert)
		BookVo vo01 = new BookVo(1, "우리들의 일그러진 영웅", "다림", "1998-02-22");
		bookDao.bookInsert(vo01);

		// 책 등록(insert)
		BookVo vo02 = new BookVo(2, "삼국지", "민음사", "2002-03-01");
		...
		// 책 수정(Update)
		BookVo updatebook = new BookVo(2, "삼국지(수정)", "민음사(수정)", "2002-03-01(수정)");
